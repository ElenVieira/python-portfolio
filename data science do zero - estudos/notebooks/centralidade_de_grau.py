...
# em seguida execute um loopin pelos pares de amigos para preenche-lá
...
avg_connections = total_connections / 10   # 24 / 10 == 2.4

# crie uma lista (user_id, number_of_friends)
num_friends_by_id = [(user["id"], number_of_friends(user))
                      for user in users]

num_friends_by_id.sort(                              # classificando a lista
    key=lambda id_and_friends: id_and_friends[1],    # por num_friends
    reverse=True)                                    # do maior par o menor.
...
# fazendo uma contagem dos amigos em comum, excluindo as e pessoas que o usuário conhece
from collections import Counter # não carrega sozino então precisa chamar
...
interests = [
    ...
    (1, "Postgres"), (2, "Python"), (2, "scikit-learning"), (2, "scipy"),
    (2, "numpy"), (2, "statsmodels"), (2, "pandas"), (3, "R"), (3, "Python"),
    (3, "statistcs"), (3, "regression"), (3, "probabillity"),
    (4, "machine learning"), (4, "regression"), (4, "decision trees"),
    (4, "libsvm"), (5, "Python"), (5, "R"), (5, "Java"), (5, "C++"),
    (5, "Haskell"), (5, "programming langueges"), (6, "statistcs"),
    (6, "probabillity"), (6, "mathematics"), (6, "theory"),
    (7, "machine learning"), (7, "scikit-learning"), (7, "Mahout"),
...
def data_scientists_who_like(target_interest):
    """Encontre os ids dos usuários com os mesmos interesses"""
    return [user_id
            for user_id, user_interest in interests
            if user_interest == target_interest]

# fazendo um indice de interesses pasa usuários

from collections import defaultdict

# as chaves são interesses, os valores são listas de user_id com o interesse em questão
